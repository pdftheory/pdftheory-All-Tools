  ...
  const handleConvert = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('json_to_pdf', files.length === 1 ? files[0].file.name : `${files.length} files`, {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                aria-label={tTools('jsonToPdf.pageSize') || 'Page Size'}
              >
            ...
            <div>
              ...
              <select
                ...
                disabled={isProcessing}
                className="w-full px-3 py-2 rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--color-primary))]"
                aria-label={tTools('jsonToPdf.fontSize') || 'Font Size'}
              >
            ...
            <div>
              ...
              <select
                ...
                disabled={isProcessing}
                className="w-full px-3 py-2 rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--color-primary))]"
                aria-label={tTools('jsonToPdf.indentSpaces') || 'Indentation'}
              >
