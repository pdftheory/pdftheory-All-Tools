          ...
          <div className="max-w-7xl mx-auto px-4 pt-24 pb-8">
            ...
            <div className="lg:grid lg:grid-cols-[1fr_300px] gap-8 items-start">
              <div className="min-w-0">
                ...
                {/* Middle Ad Slot (Under Header) */}
                <div className="mt-6 mb-2">
                  <AdUnit slotId="tool-middle-header" format="horizontal" />
                </div>
                ...
                {/* Ad Space */}
                <AdContainer slotId="tool-middle" />

                {/* SEO Content Container (Description, Use Cases, FAQ) */}
                <div className="mt-10 md:mt-16 space-y-10 md:space-y-16 border-t border-[hsl(var(--color-border))] pt-10 md:pt-16">
                  {/* Description Section */}
              ...
              {/* Desktop Sidebar Ads */}
              <aside className="hidden lg:flex flex-col gap-8 h-full">
                <div className="sticky top-24">
                  <AdUnit slotId="sidebar-top" className="!my-0" />
                  <div className="mt-8">
                    <AdUnit slotId="sidebar-sticky" className="!my-0" />
                  </div>
                </div>
              </aside>
            </div>

            {/* Related Tools Section - Full width below the grid */}
            <div className="mt-16">
              <RelatedToolsSection
                tools={relatedTools}
                locale={locale}
  ...
  return (
    <header className="text-center" data-testid="tool-page-header" itemScope itemType="https://schema.org/SoftwareApplication">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <IconComponent className="w-12 h-12 text-[hsl(var(--color-primary))]" />
      </div>
      <h1
            ...
            >
              <Card hover clickable className="h-full glass-card transition-all duration-300 group-hover:-translate-y-1">
                <div className="flex items-center gap-4">
                  <div
                    className="flex-shrink-0 w-16 h-16 rounded-xl bg-[hsl(var(--color-primary)/0.1)] flex items-center justify-center group-hover:bg-[hsl(var(--color-primary))] transition-colors duration-300"
                    aria-hidden="true"
                  >
                    <IconComponent className="w-12 h-12 text-[hsl(var(--color-primary))] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
