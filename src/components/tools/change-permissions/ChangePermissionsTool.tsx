  ...
  const handleChangePermissions = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('change-permissions', file.name, {
          status: 'success',
          fileCount: 1,
          fileSize: file.size,
          // pageCount not available directly in file object, but maybe in metadata if we loaded it?
          // The file object is just a File.
        });
      } else {
      ...
      {file && (
        <Card variant="outlined">
          ...
          <div className="space-y-4">
            ...
            {/* Current Password */}
            <div>
              <label htmlFor="current-password" className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-1">
            ...
            {/* New User Password */}
            <div>
              <label htmlFor="new-user-password" className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-1">
            ...
            {/* New Owner Password */}
            <div>
              <label htmlFor="new-owner-password" className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-1">
