    ...
    const handleRotate = useCallback(async () => {
        ...
        try {
            ...
            if (output.success && output.result) {
                ...
                setStatus('complete');
                logToolUsage('rotate-custom', file.name, {
                    rotatedPageCount: Object.keys(rotations).length,
                    fileSize: file.size
                });
            } else {
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center">
                                ...
                                <input
                                    ...
                                    aria-label="Batch rotation angle"
                                />
                                <Button
                                    variant="outline"
                                    size="icon"
                                ...
                                >
                                    ...
                                    <div className="p-2 flex items-center justify-center gap-1 border-t border-[hsl(var(--color-border))] bg-[hsl(var(--color-muted)/0.3)]">
                                        ...
                                        <input
                                            ...
                                            aria-label={`Rotation for page ${preview.pageNumber}`}
                                        />
                                        <button
                                            type="button"
                                            onClick={() => adjustPageRotation(preview.pageNumber, 1)}
