  ...
  const handleDivide = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('divide_pages', file.name, {
          divisionType,
          outputPages: totalPages * getSectionsPerPage(divisionType),
          fileSize: file.size
        });
      } else {
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className={`p-4 rounded-[var(--radius-md)] border-2 transition-all ${divisionType === 'vertical'
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className={`p-4 rounded-[var(--radius-md)] border-2 transition-all ${divisionType === 'horizontal'
                      ? 'border-[hsl(var(--color-primary))] bg-[hsl(var(--color-primary)/0.1)]'
                      : 'border-[hsl(var(--color-border))] hover:border-[hsl(var(--color-primary)/0.5)]'
                    }`}
                >
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className={`p-4 rounded-[var(--radius-md)] border-2 transition-all ${divisionType === 'grid-2x2'
                      ? 'border-[hsl(var(--color-primary))] bg-[hsl(var(--color-primary)/0.1)]'
                      : 'border-[hsl(var(--color-border))] hover:border-[hsl(var(--color-primary)/0.5)]'
                    }`}
                >
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className={`p-4 rounded-[var(--radius-md)] border-2 transition-all ${divisionType === 'grid-3x3'
                      ? 'border-[hsl(var(--color-primary))] bg-[hsl(var(--color-primary)/0.1)]'
                      : 'border-[hsl(var(--color-border))] hover:border-[hsl(var(--color-primary)/0.5)]'
                    }`}
                >
