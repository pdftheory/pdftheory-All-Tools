  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('table-of-contents', file.name, {
          title,
          addBookmark,
          fileSize: file.size
        });
        ...
        <>
          ...
          <Card variant="outlined" size="lg">
            ...
            <div className="space-y-4">
              ...
              {/* Font Size */}
              <div>
                <label htmlFor="toc-font-size" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                  {tTools('fontSize')}
                </label>
                <select
                  id="toc-font-size"
              ...
              <div>
                <label htmlFor="toc-font-family" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                  {tTools('fontFamily')}
                </label>
                <select
                  id="toc-font-family"
