  ...
  const handleCombine = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('combine_single_page', file.name, {
          status: 'success',
          fileCount: 1,
          fileSize: file.size,
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  aria-label={tTools('combineSinglePage.backgroundColorHex') || 'Background Color Hex Code'}
                />
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      disabled={isProcessing}
                      className="flex-1 px-3 py-2 rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-background))] text-[hsl(var(--color-foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--color-primary))]"
                      aria-label={tTools('combineSinglePage.separatorColorHex') || 'Separator Color Hex Code'}
                    />
                  </div>
                </div>
              </>
