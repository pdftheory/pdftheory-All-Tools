  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('form_creator', file.name, {
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-3 p-2 bg-white border border-gray-200 rounded-lg shadow-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  aria-label={tTools('formCreator.selectToolLabel') || 'Select Tool'}
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-2 py-1.5 text-sm border rounded-md bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  aria-label={tTools('formCreator.selectTemplateLabel') || 'Select Template'}
                >
            ...
            <Card variant="outlined" size="sm">
              <div
                ref={containerRef}
                className="relative bg-gray-100 rounded-[var(--radius-md)] overflow-auto max-h-[600px]"
              >
                <div
                  className={`relative inline-block ${currentTool !== 'select' ? 'cursor-crosshair' : 'cursor-default'}`}
                ...
                >
                  ...
                  {currentPageFields.map(field => (
                    <div
                      ...
                      style={{
                        // @ts-ignore
                        '--field-left': `${field.x * scale}px`,
                        // @ts-ignore
                        '--field-top': `${(pageSize.height / scale - field.y) * scale - (field.height * scale)}px`,
                        // @ts-ignore
                        '--field-width': `${field.width * scale}px`,
                        // @ts-ignore
                        '--field-height': `${field.height * scale}px`,
                      }}
                      className={`absolute left-[var(--field-left)] top-[var(--field-top)] w-[var(--field-width)] h-[var(--field-height)] flex items-center justify-center text-[10px] text-gray-700 select-none ${field.id === selectedFieldId
                        ? 'border-2 border-blue-500 bg-blue-500/10'
                        : 'border-2 border-dashed border-gray-500 bg-gray-500/10'
                    ...
                    >
                      ...
                      {field.label && (
                        <span
                          className={`absolute text-[8px] text-blue-600 bg-blue-50 px-1 rounded whitespace-nowrap ${field.labelPosition === 'left'
                            ? 'right-full top-1/2 -translate-y-1/2 mr-0.5'
                            : 'bottom-full left-0 mb-px'
                            }`}
                        >
                          {field.label}
                        </span>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden flex flex-col max-h-[calc(100vh-200px)]">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                        ...
                        <input
                          ...
                          aria-label={tTools('formCreator.fieldNameLabel') || 'Field Name'}
                        />
                      </div>
                      ...
                      <select
                        ...
                        aria-label={tTools('formCreator.fieldTypeLabel') || 'Field Type'}
                      >
                        <option value="text">📝 {tTools('formCreator.textFieldTool')}</option>
                        <option value="checkbox">☑ {tTools('formCreator.checkboxTool')}</option>
                        <option value="dropdown">▼ {tTools('formCreator.dropdownTool')}</option>
                        ...
                        {['x', 'y', 'width', 'height'].map((prop, idx) => (
                          <div key={prop}>
                            ...
                            <input
                              ...
                              aria-label={tTools('formCreator.' + prop + 'Label') || prop.toUpperCase()}
                            />
                          </div>
                        ))}
                      </div>
                      ...
                      {(selectedField.type === 'dropdown' || selectedField.type === 'radio' || selectedField.type === 'listbox') && (
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 border rounded-[var(--radius-md)] text-sm"
                            rows={4}
                            aria-label={tTools('formCreator.optionsLabel') || 'Field Options'}
                          />
                        </div>
                      )}
                      ...
                      {(selectedField.type === 'dropdown' || selectedField.type === 'radio' || selectedField.type === 'listbox') && selectedField.options && selectedField.options.length > 0 && (
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => updateSelectedField({ defaultValue: e.target.value })}
                            className="w-full px-3 py-2 border rounded-[var(--radius-md)] text-sm"
                            aria-label={tTools('formCreator.defaultSelectionLabel') || 'Default Selection'}
                          >
                      ...
                      {selectedField.type === 'date' && (
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3 py-2 border rounded-[var(--radius-md)] text-sm"
                            aria-label={tTools('formCreator.dateFormatLabel') || 'Date Format'}
                          >
                      ...
                      {selectedField.type === 'date' && (
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateSelectedField({ defaultValue: e.target.value })}
                            className="w-full px-3 py-2 border rounded-[var(--radius-md)] text-sm"
                            aria-label={tTools('formCreator.defaultDateLabel') || 'Default Date'}
                          />
                        </div>
                      )}
                        ...
                        >
                          ...
                          <div className="flex gap-1">
                            <button
                              ...
                              title={tTools('formCreator.loadProject') || 'Load Project'}
                            >
                            ...
                            <button
                              ...
                              title={tTools('formCreator.deleteProject') || 'Delete Project'}
                            >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border rounded-[var(--radius-md)] text-sm"
                  aria-label={tTools('formCreator.pageSizeLabel') || 'Page Size'}
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border rounded-[var(--radius-md)] text-sm"
                  aria-label={tTools('formCreator.pageCountLabel') || 'Number of Pages'}
                />
              </div>
