  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('watermark_pdf', file.name, { type: watermarkType });
      } else {
          ...
          <Card variant="outlined" size="lg">
            ...
            {watermarkType === 'text' && (
              <div className="space-y-4">
                <div>
                  <label htmlFor="watermark-text" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="watermark-font-size" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                      {tTools('fontSize')}
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="watermark-color" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                      {tTools('color')}
                    </label>
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        disabled={isProcessing}
                        aria-label={tTools('colorHex') || 'Color Hex Code'}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="watermark-text-opacity" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                  ...
                  <div>
                    <label htmlFor="watermark-text-angle" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                      {tTools('angle')}: {textAngle}°
                    </label>
                    <input
                      id="watermark-text-angle"
                      type="range"
                      value={textAngle}
            ...
            {watermarkType === 'image' && (
              <div className="space-y-4">
                <div>
                  <label htmlFor="watermark-image-file" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="watermark-image-opacity" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                  ...
                  <div>
                    <label htmlFor="watermark-image-angle" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">
                      {tTools('angle')}: {imageAngle}°
                    </label>
                    <input
                      id="watermark-image-angle"
                      type="range"
                      value={imageAngle}
