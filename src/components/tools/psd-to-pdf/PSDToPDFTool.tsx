    ...
    const handleConvert = useCallback(async () => {
        ...
        try {
            ...
            if (output.success && output.result) {
                ...
                setStatus('complete');
                logToolUsage('psd-to-pdf', files[0].file.name, {
            ...
            {files.length >= 1 && (
                <Card variant="outlined">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {/* Page Size */}
                        <div>
                            <label htmlFor="psd-page-size" className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-2">
                        ...
                        {/* Orientation */}
                        <div>
                            <label htmlFor="psd-orientation" className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-2">
                        ...
                        {/* Margin */}
                        <div>
                            <label htmlFor="psd-margin" className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-2">
