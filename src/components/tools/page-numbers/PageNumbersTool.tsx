  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        setStatus('complete');
        logToolUsage('page_numbers', file.name, {
          fileSize: file.size,
          pages: totalPages,
          position,
          style: format,
        ...
        <div className="grid lg:grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div>
                  ...
                  <select
                    ...
                    disabled={isProcessing}
                    aria-label={tTools('pageNumbers.style') || 'Style'}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1.5 text-sm border rounded-md"
                    disabled={isProcessing}
                    aria-label={tTools('pageNumbers.startNumber') || 'Start Number'}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1.5 text-sm border rounded-md"
                    disabled={isProcessing}
                    aria-label={tTools('pageNumbers.fontSize') || 'Font Size'}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1.5 text-sm border rounded-md"
                    disabled={isProcessing}
                    aria-label={tTools('pageNumbers.margin') || 'Margin'}
                  />
                </div>
              </div>
              <div className="mb-3">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    disabled={isProcessing}
                    aria-label={tTools('pageNumbers.selectColor') || 'Select Color'}
                  />
                  <input
                    type="text"
                    value={fontColor}
                    ...
                    disabled={isProcessing}
                    aria-label={tTools('pageNumbers.colorHex') || 'Color Hex'}
                  />
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-2 py-1.5 text-sm border rounded-md"
                      disabled={isProcessing}
                      aria-label={tTools('pageNumbers.pageMode') || 'Page Mode'}
                    >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-2 py-1.5 text-sm border rounded-md"
                          disabled={isProcessing}
                          aria-label={tTools('pageNumbers.oddPosition') || 'Odd Page Position'}
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-2 py-1.5 text-sm border rounded-md"
                          disabled={isProcessing}
                          aria-label={tTools('pageNumbers.evenPosition') || 'Even Page Position'}
                        >
                          <option value="bottom-left">{tTools('pageNumbers.posBottomLeft')}</option>
                          <option value="bottom-center">{tTools('pageNumbers.posBottomCenter')}</option>
                          <option value="bottom-right">{tTools('pageNumbers.posBottomRight')}</option>
          ...
          <div>
            <Card variant="outlined" size="lg">
              ...
              <div className="bg-gray-100 dark:bg-gray-800 rounded-[var(--radius-md)] p-4 overflow-auto max-h-[600px] min-h-[500px]">
                <div
                  className="flex justify-center origin-top scale-[var(--scale)] min-h-[var(--min-height)]"
                  style={{
                    // @ts-ignore
                    '--scale': previewScale,
                    // @ts-ignore
                    '--min-height': previewScale < 1 ? 'auto' : undefined
                  }}
                >
                  <canvas
