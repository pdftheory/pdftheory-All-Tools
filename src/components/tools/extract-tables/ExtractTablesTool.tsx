...
export function ExtractTablesTool({ className = '' }: ExtractTablesToolProps) {
    ...
    const handleExtract = useCallback(async () => {
        ...
        try {
            ...
            if (output.success && output.result) {
                ...
                logToolUsage('extract-tables', file.name, {
                    format: format,
    ...
    }, [file, format, pageRange, minColumns, minRows, includePageNumbers, logToolUsage]);
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    aria-label={tTools('extractTables.minColumnsLabel') || 'Min Columns'}
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-[hsl(var(--color-foreground))] mb-2">
                                ...
                                <input
                                    ...
                                    disabled={isProcessing}
                                    className="w-full h-2 rounded-lg appearance-none cursor-pointer bg-[hsl(var(--color-muted))]"
                                    aria-label={tTools('extractTables.minRowsLabel') || 'Min Rows'}
                                />
                            </div>
                        </div>
