...
export function HeaderFooterTool({ className = '' }: HeaderFooterToolProps) {
  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      if (output.success && output.result) {
        ...
        logToolUsage('header-footer', file.name, {
          fontSize,
          margin,
          hasHeader: !!(headerLeft || headerCenter || headerRight),
          hasFooter: !!(footerLeft || footerCenter || footerRight)
        });
      } else {
  ...
  }, [file, headerLeft, headerCenter, headerRight, footerLeft, footerCenter, footerRight, fontSize, fontColor, margin, skipFirstPage, pageRange, logToolUsage]);
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    disabled={isProcessing}
                    aria-label={tTools('headerFooter.fontSize') || 'Font Size'}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border rounded-[var(--radius-md)]"
                    disabled={isProcessing}
                    aria-label={tTools('headerFooter.margin') || 'Margin'}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    disabled={isProcessing}
                    aria-label={tTools('headerFooter.fontColor') || 'Text Color'}
                  />
                </div>
              </div>
            ...
            <Card variant="outlined" size="lg">
              ...
              <div className="bg-gray-100 rounded-[var(--radius-md)] p-4 flex justify-center">
                <canvas
                  ...
                  className="shadow-lg bg-white max-w-full h-auto max-h-[500px]"
                />
              </div>
