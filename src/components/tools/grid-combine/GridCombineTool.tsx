...
export function GridCombineTool({ className = '' }: GridCombineToolProps) {
    ...
    const handleCombine = useCallback(async () => {
        ...
        try {
            ...
            if (output.success && output.result) {
                ...
                logToolUsage('grid-combine', `grid_combine_${files.length}_files.pdf`, {
    ...
    }, [files, gridLayout, pageSize, orientation, useMargins, addBorder, borderColor, spacing, fillMode, pageMode, tTools, logToolUsage]);
                                    ...
                                    >
                                        ...
                                        <div className="flex-shrink-0 flex items-center gap-1">
                                            <button
                                                ...
                                                title={tTools('gridCombine.moveUp') || 'Move Up'}
                                                aria-label={tTools('gridCombine.moveUp') || 'Move Up'}
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-1 rounded hover:bg-[hsl(var(--color-muted))] disabled:opacity-30 disabled:cursor-not-allowed"
                                                title={tTools('gridCombine.moveDown') || 'Move Down'}
                                                aria-label={tTools('gridCombine.moveDown') || 'Move Down'}
                                            >
                                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                                    <path d="M6 9l6 6 6-6" />
                                                </svg>
                                        ...
                                        <button
                                            ...
                                            title={tTools('gridCombine.removeFile') || 'Remove File'}
                                            aria-label={tTools('gridCombine.removeFile') || 'Remove File'}
                                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="mt-3 p-3 bg-[hsl(var(--color-muted)/0.3)] rounded-[var(--radius-md)]">
                                        ...
                                        <div
                                            className={`grid mx-auto border border-[hsl(var(--color-border))] rounded bg-white transition-all duration-300 ease-in-out ${orientation === 'landscape' ? 'w-[160px] h-[120px]' : 'w-[120px] h-[160px]'
                                                } grid-cols-[repeat(var(--cols),1fr)] grid-rows-[repeat(var(--rows),1fr)] gap-[var(--gap)] p-[var(--padding)]`}
                                            style={{
                                                // @ts-ignore
                                                '--cols': cols,
                                                // @ts-ignore
