...
type FieldType = 'text' | 'number' | 'select' | 'checkbox' | 'range' | 'color' | 'file';
...
const getToolSettingsConfig = (): Record<string, ToolSettingsConfig> => ({
    // ==================== Compress PDF ====================
    'compress-pdf': {
        titleKey: 'compressPdf.title',
        fields: [
            {
                key: 'quality',
                labelKey: 'compressPdf.title',
                type: 'select',
                defaultValue: 'standard',
                options: [
                    { value: 'standard', labelKey: 'compressPdf.standard' },
                    { value: 'high', labelKey: 'compressPdf.high' },
                    { value: 'low', labelKey: 'compressPdf.low' },
                ],
            },
            {
                key: 'imageQuality',
                labelKey: 'compressPdf.imageQuality',
                type: 'range',
                defaultValue: 80,
                min: 10,
                max: 100,
            ...
            {
                key: 'targetDpi',
                labelKey: 'compressPdf.targetDpi',
                type: 'select',
                defaultValue: '150',
                options: [
                    { value: '72', labelKey: '72 DPI (Web)' },
                    { value: '96', labelKey: '96 DPI (Standard)' },
                    { value: '150', labelKey: '150 DPI (eBook)' },
                    { value: '300', labelKey: '300 DPI (Print)' },
                ],
            },
            {
                key: 'optimizeImages',
            ...
            },
            {
                ...
                labelKey: 'compressPdf.removeBlankPages',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeDuplicatePages',
                labelKey: 'compressPdf.removeDuplicatePages',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'flattenForms',
                labelKey: 'compressPdf.flattenForms',
                type: 'checkbox',
                defaultValue: false,
            },
            {
    ...
    'add-watermark': {
        ...
        fields: [
            ...
            },
            {
                ...
                visibleIf: { field: 'watermarkType', value: 'image' },
            },
            {
                key: 'text',
                ...
                visibleIf: { field: 'watermarkType', value: 'text' },
            },
            {
                key: 'position',
    ...
    'header-footer': {
        ...
        fields: [
            ...
            {
                key: 'pageRange',
                labelKey: 'headerFooter.pageRange',
                type: 'text',
                defaultValue: 'all',
                placeholderKey: 'headerFooter.pageRangePlaceholder',
            },
        ],
    },
    ...
    'text-color': {
        ...
        fields: [
            ...
            {
                key: 'mode',
                labelKey: 'textColor.modeLabel',
                type: 'select',
                defaultValue: 'dark',
                options: [
                    { value: 'dark', labelKey: 'textColor.modeDark' },
                    { value: 'light', labelKey: 'textColor.modeLight' },
                ],
            },
            {
                key: 'threshold',
                labelKey: 'textColor.thresholdLabel',
                type: 'number',
                defaultValue: 128,
                min: 0,
                max: 255,
            ...
            {
                key: 'scope',
                labelKey: 'textColor.scopeLabel',
                type: 'select',
                defaultValue: 'all',
                options: [
                    { value: 'all', labelKey: 'textColor.scopeAll' },
                    { value: 'word', labelKey: 'textColor.scopeWord' },
                    { value: 'line', labelKey: 'textColor.scopeLine' },
                ],
            },
            {
                key: 'searchValue',
                labelKey: 'textColor.searchValueLabel',
                type: 'text',
                defaultValue: '',
                placeholderKey: 'textColor.searchValuePlaceholder',
                // Show only if scope is not 'all'
                condition: (settings) => settings.scope && settings.scope !== 'all',
            },
        ],
    },
    'add-stamps': {
    ...
    'remove-annotations': {
        ...
        fields: [
            ...
            {
                key: 'removeShapes',
                labelKey: 'removeAnnotations.removeShapes',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeImages',
                labelKey: 'removeAnnotations.removeImages',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeForms',
                labelKey: 'removeAnnotations.removeForms',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeJS',
                labelKey: 'removeAnnotations.removeJS',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeMetadata',
                labelKey: 'removeAnnotations.removeMetadata',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeBookmarks',
                labelKey: 'removeAnnotations.removeBookmarks',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeRedactions',
                labelKey: 'removeAnnotations.removeRedactions',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeUnderline',
                labelKey: 'removeAnnotations.removeUnderline',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeStrikeOut',
                labelKey: 'removeAnnotations.removeStrikeOut',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeSquiggly',
                labelKey: 'removeAnnotations.removeSquiggly',
                type: 'checkbox',
                defaultValue: false,
            },
            {
                key: 'removeDrawings',
                labelKey: 'removeAnnotations.removeDrawings',
                type: 'checkbox',
                defaultValue: false,
            },
        ],
                ...
                {!config || config.fields.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        ...
                        {config.fields.map(field => {
                            ...
                            if (field.visibleIf) {
                                const dependentValue = settings[field.visibleIf.field];
                                    ...
                                    {field.type === 'color' && (
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                onChange={(e) => handleFieldChange(field.key, e.target.value)}
                                                title={`${getTranslation(field.labelKey)} color picker`}
                                            ...
                                            <input
                                                ...
                                                value={(settings[field.key] as string) || ''}
                                                onChange={(e) => handleFieldChange(field.key, e.target.value)}
                                                title={`${getTranslation(field.labelKey)} hex value`}
                                                placeholder="#000000"
                                    ...
                                    {field.type === 'file' && (
                                        <div className="space-y-1.5">
                                            <input
                                                ...
                                                className="w-full text-xs text-[hsl(var(--color-muted-foreground))] file:mr-4 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-[hsl(var(--color-primary))] file:text-[hsl(var(--color-primary-foreground))] hover:file:opacity-90 cursor-pointer"
                                            />
                                            {settings[field.key] instanceof File && (
                                                <p className="text-xs text-[hsl(var(--color-primary))] font-medium truncate">
