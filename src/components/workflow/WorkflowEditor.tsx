            ...
            for (let i = 0; i < executionOrder.length; i++) {
                ...
                const result = await executeNode(
                    ...
                    (progress) => {
                        ...
                        // Update global workflow progress
                        // Formula: (Current Node Index + (Node Progress / 100)) / Total Nodes
                        setExecutionState(prev => ({
                            ...prev,
                            progress: Math.round(((i + (Math.min(progress, 100) / 100)) / executionOrder.length) * 100)
                        }));
                    }
                );
    ...
    return (
        <div className="flex h-full relative">
            ...
            <WorkflowPreview
                ...
                outputFiles={executionState.outputFiles}
