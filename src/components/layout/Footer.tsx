          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <button className="relative flex items-center gap-3 bg-gray-800/50 border border-gray-700/50 rounded-lg px-4 py-2 cursor-not-allowed group text-left opacity-70" disabled>
                <img src="/images/google-play-icon.png" alt="Google Play" width={32} height={32} className="w-8 h-8 filter grayscale opacity-60" />
                <div>
              ...
              <button className="relative flex items-center gap-3 bg-gray-800/50 border border-gray-700/50 rounded-lg px-4 py-2 cursor-not-allowed group text-left opacity-70" disabled>
                <img src="/images/app-store-icon.png" alt="App Store" width={32} height={32} className="w-8 h-8 filter invert opacity-60" />
                <div>
