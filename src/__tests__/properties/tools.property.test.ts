...
describe('Tool Configuration Property Tests', () => {
        ...
        fc.property(
          ...
          (query) => {
            ...
            for (const result of results) {
              ...
              // With the new search, we check if the tool actually matched the query
              // toolMatchesQuery uses the same logic as searchTools
              expect(toolMatchesQuery(result.tool, query)).toBe(true);
            }
  ...
  describe('Tool Configuration Integrity', () => {
    ...
    it('getAllTools returns all 100 tools', () => {
