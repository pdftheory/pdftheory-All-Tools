...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} PDFTheory. All rights reserved.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "PDFTheory" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays PDFTheory brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('PDFTheory');
    ...
    it('Footer component displays PDFTheory brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('PDFTheory');
      ...
      fc.assert(
        fc.property(
          ...
          (invalidLocale) => {
            ...
            localStorage.setItem('pdftheory-language-preference', invalidLocale);
