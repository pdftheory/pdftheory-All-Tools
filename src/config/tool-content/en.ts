...
export const toolContentEn: Record<string, ToolContent> = {
  ...
  'compress-pdf': {
    title: 'Compress PDF',
    metaDescription: 'Reduce PDF file size online. Compress PDF documents while maintaining quality. Optimize images and remove unnecessary data.',
    keywords: ['compress pdf', 'reduce pdf size', 'optimize pdf', 'shrink pdf', 'pdf compressor'],
    description: `
      <p>Compress PDF allows you to significantly reduce the size of your PDF documents without compromising quality. Perfect for emailing large files, saving storage space, or optimizing documents for web viewing.</p>
      <p>Choose from different compression levels to balance file size and quality. The tool optimizes images, removes unnecessary metadata, and eliminates blank or duplicate pages to achieve the best results.</p>
      <p>All compression happens locally in your browser, ensuring your documents remain private.</p>
    `,
    howToUse: [
      ...
      { step: 2, title: 'Select Compression Level', description: 'Choose between High, Recommended, or Low compression based on your needs.' },
      { step: 3, title: 'Compress and Download', description: 'Click Compress to reduce the file size and download your optimized PDF.' },
    ],
    useCases: [
      { title: 'Email Attachments', description: 'Shrink large PDFs to meet email attachment size limits.', icon: 'mail' },
      { title: 'Web Optimization', description: 'Optimize PDFs for faster loading on websites and mobile devices.', icon: 'globe' },
      { title: 'Storage Management', description: 'Reduce file sizes to save space on your computer or cloud storage.', icon: 'hard-drive' },
    ],
    faq: [
      { question: 'Will the quality be reduced?', answer: 'It depends on the compression level. "Recommended" maintains good quality, while "High" sacrifices some quality for maximum size reduction.' },
      { question: 'Can I compress password-protected PDFs?', answer: 'You need to decrypt the PDF first using our Decrypt PDF tool before compressing.' },
      { question: 'What happens to images?', answer: 'Images are optimized and resampled based on the selected compression level to reduce file size.' },
    ],
  },
  ...
  'pdf-to-txt': {
    title: 'PDF to Text',
    metaDescription: 'Extract text from PDF documents instantly. Free online PDF to TXT converter with OCR support for scanned files. Privacy-first.',
    keywords: ['pdf to txt', 'pdf to text', 'extract text from pdf', 'convert pdf to text', 'ocr pdf to text'],
    description: `
      <p>Need to extract text from a PDF document? Our PDF to Text converter makes it simple to pull plain text content from any PDF file. It's perfect for data analysis, content migration, or simply getting editable text from read-only documents.</p>
      <p>This tool runs entirely in your browser using advanced client-side technology, ensuring your sensitive documents never leave your device. It even includes built-in OCR (Optical Character Recognition) to handle scanned documents and images automatically.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload PDF', description: 'Select your PDF file from your device.' },
      { step: 2, title: 'Extract Text', description: 'The tool automatically processes the file and extracts all available text.' },
      { step: 3, title: 'Copy or Download', description: 'Copy the extracted text to your clipboard or download it as a .txt file.' },
    ],
    useCases: [
      { title: 'Content Migration', description: 'Quickly move content from legacy PDF documents into a CMS or database.', icon: 'arrow-right-circle' },
      { title: 'Data Analysis', description: 'Extract raw text for natural language processing or text analysis tools.', icon: 'bar-chart-2' },
      { title: 'Scanned Documents', description: 'Convert scanned contracts or letters into editable text using our built-in OCR.', icon: 'scan' },
    ],
    faq: [
      { question: 'Does this handle scanned PDFs?', answer: 'Yes! If the tool detects that a page is an image (scanned), it automatically uses OCR to recognize and extract the text.' },
      { question: 'Is my data secure?', answer: 'Absolutely. All processing happens in your browser. Your PDF files are never uploaded to our servers.' },
      { question: 'Is formatting preserved?', answer: 'This tool focuses on extracting raw text for maximum compatibility. If you need to preserve layout, try our PDF to HTML/Word tools.' },
    ],
  },
  'ocr-pdf': {
    title: 'OCR PDF',
  ...
  'add-metadata': {
    title: 'Add Metadata',
    metaDescription: 'Add metadata to PDF documents. Add title, author, subject, keywords, and more.',
    keywords: ['add metadata', 'pdf metadata', 'document properties', 'pdf info', 'add pdf details'],
    description: `
      <p>Add Metadata allows you to add or update document properties and metadata in your PDF files. Add title, author, subject, keywords, creation date, modification date, and more.</p>
      <p>Useful for organizing documents, adding attribution, or preparing files for distribution.</p>
      <p>All processing happens in your browser, ensuring your documents remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Add Metadata', description: 'Enter the metadata fields you want to add or update.' },
      { step: 3, title: 'Save and Download', description: 'Click Save to apply changes and download.' },
    ],
    useCases: [
      { title: 'Document Organization', description: 'Add metadata for better file organization.', icon: 'folder' },
      { title: 'Attribution', description: 'Add author and creator information.', icon: 'user' },
      { title: 'Searchability', description: 'Add keywords to improve document searchability.', icon: 'search' },
    ],
    faq: [
      { question: 'What fields can I add?', answer: 'Title, author, subject, keywords, creator, and producer fields.' },
      { question: 'Will existing metadata be overwritten?', answer: 'Yes, if you provide new values for existing fields.' },
      { question: 'Is XMP metadata supported?', answer: 'Yes, both standard and XMP metadata are updated.' },
    ],
  },
  ...
  'workflow': {
    ...
    description: `
      <p>PDF Workflow allows you to create custom, automated processing pipelines for your PDF documents. Instead of performing multiple steps manually, you can build a visual workflow that combines merging, splitting, compressing, and more into a single execution.</p>
      <p>Build your workflow using our intuitive drag-and-drop builder, save it for future use, and process hundreds of documents consistently and quickly. Whether you need to prepare monthly reports or process a batch of invoices, PDF Workflow streamlines your tasks.</p>
      <p>All processing occurs directly in your browser, ensuring your documents remain private throughout the entire workflow execution.</p>
    `,
    howToUse: [
      { step: 1, title: 'Open Workflow Builder', description: 'Access the visual builder to start creating your PDF processing pipeline.' },
      { step: 2, title: 'Add and Connect Tools', description: 'Select the tools you need (e.g., Merge, Compress, Watermark) and connect them in your desired order.' },
      { step: 3, title: 'Configure Settings', description: 'Set parameters for each tool in the pipeline, such as compression level or watermark text.' },
      { step: 4, title: 'Execute and Save', description: 'Run your workflow with your documents and save the template for future use.' },
    ],
    useCases: [
      { title: 'Report Automation', description: 'Automate the assembly, branding, and optimization of monthly financial reports.', icon: 'file-bar-chart' },
      { title: 'Batch Optimization', description: 'Compress and linearize entire archives of PDF documents for web distribution.', icon: 'archive' },
      { title: 'Consistent Branding', description: 'Apply watermarks, headers, and footers consistently across all company documents.', icon: 'shield-check' },
    ],
    faq: [
      { question: 'Is there a limit to workflow steps?', answer: 'You can add up to 20 processing steps to a single workflow pipeline.' },
      { question: 'Can I save my workflows?', answer: 'Yes, workflows can be saved as templates in your browser for recurring tasks.' },
      { question: 'Will my data stay private?', answer: 'Absolutely. All processing is done locally in your browser, and no files ever leave your device.' },
    ],
  },

  'html-to-pdf': {
    title: 'HTML to PDF',
    metaDescription: 'Convert HTML files and raw HTML code to professional PDF documents. Client-side conversion ensures complete privacy.',
    keywords: ['html to pdf', 'convert html', 'webpage to pdf', 'html converter', 'code to pdf'],
    description: `
      <p>HTML to PDF converts your HTML files or raw HTML code into high-quality PDF documents. Whether you have an HTML file from your computer or want to write HTML code directly, this tool creates professional PDFs instantly.</p>
      <p>Features include live preview, multiple page sizes (A4, Letter, Legal), portrait and landscape orientations, and adjustable quality settings. Perfect for converting web pages, reports, invoices, or any HTML content.</p>
      <p>All conversion happens entirely in your browser using advanced rendering technology. Your HTML never leaves your device, ensuring complete privacy and security.</p>
    `,
    howToUse: [
      { step: 1, title: 'Choose Input Mode', description: 'Select whether to write HTML code directly or upload an HTML file from your device.' },
      { step: 2, title: 'Enter or Upload HTML', description: 'Write your HTML code in the editor with live preview, or upload an existing .html file.' },
      { step: 3, title: 'Configure Options', description: 'Select page size (A4, Letter, Legal), orientation (Portrait/Landscape), and quality level.' },
      { step: 4, title: 'Convert and Download', description: 'Click Convert to PDF to generate your document and download the result.' },
    ],
    useCases: [
      { title: 'Web Page Archiving', description: 'Convert web pages and HTML content to PDF for offline storage and sharing.', icon: 'globe' },
      { title: 'Report Generation', description: 'Create professional PDF reports from HTML templates with custom styling.', icon: 'file-text' },
      { title: 'Invoice Creation', description: 'Convert HTML invoices and receipts to PDF format for clients.', icon: 'receipt' },
    ],
    faq: [
      { question: 'Does it support CSS styling?', answer: 'Yes, full CSS styling is supported including colors, fonts, layouts, tables, and gradients.' },
      { question: 'Is my HTML code kept private?', answer: 'Absolutely. All conversion happens in your browser. Your HTML never leaves your device.' },
      { question: 'Can I include images in my HTML?', answer: 'Yes, embedded images (base64) and inline styles are fully supported.' },
    ],
  },

  'pdf-to-html': {
    title: 'PDF to HTML',
    metaDescription: 'Convert PDF documents to clean, semantic HTML code. Preserve layout and styling.',
    keywords: ['pdf to html', 'convert pdf to html', 'pdf converter', 'pdf to code', 'extract html from pdf'],
    description: `
      <p>PDF to HTML converts your PDF documents into clean, semantic HTML code that you can use on websites or in other applications. The tool extracts text and structure while preserving the original layout as much as possible.</p>
      <p>Choose from three output modes: Styled (preserves visual layout), Structured (semantic HTML with basic structure), or Plain (raw content). You can also include CSS styles and choose whether to wrap the content in a full HTML document.</p>
      <p>All extraction happens entirely in your browser using advanced PDF parsing technology. Your documents remain completely private and secure.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload PDF', description: 'Drag and drop your PDF file or click to upload the document you want to convert.' },
      { step: 2, title: 'Choose Output Style', description: 'Select "Styled" for visual fidelity, "Structured" for clean semantics, or "Plain" for raw text.' },
      { step: 3, title: 'Configure Options', description: 'Toggle options like "Preserve layout", "Include page breaks", and "Include CSS styles".' },
      { step: 4, title: 'Convert and Download', description: 'Click Convert to generate the HTML code, then download the file or copy the code.' },
    ],
    useCases: [
      { title: 'Web Content Extraction', description: 'Extract content from PDF reports or articles for publication on websites.', icon: 'layout' },
      { title: 'Document Migration', description: 'Convert legacy PDF documentation into modern, searchable HTML format.', icon: 'database' },
      { title: 'E-book Creation', description: 'Convert PDF books into reflowable HTML for EPUB creation or reading apps.', icon: 'book' },
    ],
    faq: [
      { question: 'Is the HTML responsive?', answer: 'The "Structured" mode produces semantic HTML that flows naturally, while "Styled" mode tries to preserve the fixed layout of the PDF.' },
      { question: 'Are images extracted?', answer: 'Currently, the tool focuses on text and structure extraction. We are working on image extraction support.' },
      { question: 'Does it support multi-page PDFs?', answer: 'Yes, the tool processes all pages and can include page break markers between them.' },
    ],
  },
  'pdf-to-heic': {
    title: 'PDF to HEIC',
    metaDescription: 'Convert PDF pages to high-quality HEIC images. Preserve detail with Apple\'s efficient image format.',
    keywords: ['pdf to heic', 'convert pdf to heif', 'pdf to apple image', 'export pdf as heic'],
    description: `
      <p>PDF to HEIC converts your PDF pages into Apple's high-efficiency HEIC image format. HEIC offers superior image quality at smaller file sizes compared to JPEG.</p>
      <p>Customize the output quality and DPI to match your needs. Perfect for saving space while maintaining high resolution for photos and graphics extracted from PDFs.</p>
      <p>All processing happens locally in your browser, ensuring your documents remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Configure Settings', description: 'Select page range, quality, and DPI for the HEIC output.' },
      { step: 3, title: 'Convert and Download', description: 'Process pages and download your HEIC images.' },
    ],
    useCases: [
      { title: 'Storage Efficiency', description: 'Save high-quality images with much smaller file sizes than JPG.', icon: 'hard-drive' },
      { title: 'Apple Ecosystem', description: 'Convert PDFs to a native format for Apple devices and software.', icon: 'smartphone' },
      { title: 'High Quality', description: 'Maintain better color depth and detail than standard JPEG.', icon: 'image' },
    ],
    faq: [
      { question: 'What is HEIC?', answer: 'HEIC is a high-efficiency image container that provides better compression than JPEG.' },
      { question: 'Will it work on Windows?', answer: 'Most modern Windows 10/11 systems support HEIC, or you may need the HEVC extension.' },
      { question: 'Can I convert multiple pages?', answer: 'Yes, all selected pages are converted and can be downloaded as a ZIP.' },
    ],
  },
  'pdf-to-psd': {
    title: 'PDF to PSD',
    metaDescription: 'Convert PDF to Adobe Photoshop (PSD) files. Maintain layers and high-fidelity graphics for editing.',
    keywords: ['pdf to psd', 'convert pdf to photoshop', 'pdf to layers', 'export pdf as psd'],
    description: `
      <p>PDF to PSD converts your PDF documents into Adobe Photoshop files. This tool attempts to preserve layers and text structure, making it easier to edit PDF designs in Photoshop.</p>
      <p>High-fidelity conversion ensures that graphics and text remain sharp for professional design work. Perfect for designers who need to rework PDF assets.</p>
      <p>All processing happens locally in your browser, ensuring your designs remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Configure PSD', description: 'Select resolution and whether to attempt layer preservation.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the PSD file and download for editing.' },
    ],
    useCases: [
      { title: 'Design Editing', description: 'Open PDF designs in Photoshop with editable layers.', icon: 'palette' },
      { title: 'Graphic Recovery', description: 'Extract high-quality graphics for use in new design projects.', icon: 'image' },
      { title: 'Professional Printing', description: 'Prepare PDF assets for professional print workflows in PSD.', icon: 'printer' },
    ],
    faq: [
      { question: 'Are all layers preserved?', answer: 'The tool attempts to preserve logical layers, but complex PDF structures may be flattened.' },
      { question: 'Is the PSD compatible?', answer: 'Yes, the output is a standard PSD file compatible with Adobe Photoshop and GIMP.' },
      { question: 'Maximum file size?', answer: 'We support PDFs up to 100MB for transition to PSD.' },
    ],
  },
  'pdf-to-xps': {
    title: 'PDF to XPS',
    metaDescription: 'Convert PDF to XML Paper Specification (XPS) format. Maintain vector precision and document layout.',
    keywords: ['pdf to xps', 'convert pdf to oxps', 'pdf to microsoft archive', 'export pdf as xps'],
    description: `
      <p>PDF to XPS converts your PDF documents into Microsoft's XML Paper Specification format. XPS is an open, royalty-free standard for fixed-layout documents.</p>
      <p>Maintains vector precision and exact layout for document archiving and printing in Windows environments. Perfect for long-term storage of business documents.</p>
      <p>All processing happens locally in your browser, ensuring your documents remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Select Options', description: 'Choose between standard XPS or OpenXPS formats.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the XPS file and download.' },
    ],
    useCases: [
      { title: 'Windows Archiving', description: 'Save documents in the native Windows archival format.', icon: 'archive' },
      { title: 'Print Fidelity', description: 'Ensure high-fidelity printing in Windows-based workflows.', icon: 'printer' },
      { title: 'Standard Compliance', description: 'Convert to open standards like OpenXPS for document exchange.', icon: 'file-check' },
    ],
    faq: [
      { question: 'What is XPS?', answer: 'XPS is Microsoft\'s alternative to PDF, used for fixed-layout document printing and archiving.' },
      { question: 'Can I view XPS on Mac?', answer: 'XPS viewing on macOS requires third-party software or conversion back to PDF.' },
      { question: 'Difference between PDF and XPS?', answer: 'Both are fixed-layout; XPS is built on XML and is native to Windows printing.' },
    ],
  },
  'pdf-to-rtf': {
    title: 'PDF to RTF',
    metaDescription: 'Convert PDF to Rich Text Format (RTF). Extract text and basic formatting for easy word processing.',
    keywords: ['pdf to rtf', 'convert pdf to rich text', 'extract text from pdf', 'pdf to rtf converter'],
    description: `
      <p>PDF to RTF extracts content from your PDF and saves it as a Rich Text Format file. RTF is highly compatible with nearly all word processing software.</p>
      <p>The tool preserves basic formatting, font styles, and alignment while making the content easily editable. Perfect for extracting text when you don't need the full complexity of a DOCX file.</p>
      <p>All processing happens locally in your browser, ensuring your documents remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Extract', description: 'The tool will analyze and transform PDF content into RTF.' },
      { step: 3, title: 'Download RTF', description: 'Download your editable Rich Text document.' },
    ],
    useCases: [
      { title: 'Simple Editing', description: 'Quickly extract and edit text in any word processor.', icon: 'edit' },
      { title: 'Cross-App Support', description: 'Use extracted text in older or specialized writing software.', icon: 'copy' },
      { title: 'Layout Striping', description: 'Extract text content while removing complex PDF layout elements.', icon: 'type' },
    ],
    faq: [
      { question: 'Does it support images?', answer: 'Basic RTF support includes images, but text-heavy documents yield better results.' },
      { question: 'Will fonts be preserved?', answer: 'Standard fonts are preserved; custom embedded fonts may be mapped to similar system fonts.' },
      { question: 'Is RTF better than TXT?', answer: 'Yes, RTF maintains bold, italics, and basic layout unlike plain text.' },
    ],
  },
  'pdf-to-epub': {
    title: 'PDF to EPUB',
    metaDescription: 'Convert PDF to EPUB e-books. Reflowable text for comfortable reading on e-readers and mobile devices.',
    keywords: ['pdf to epub', 'convert pdf to ebook', 'pdf to kindle', 'reflowable pdf'],
    description: `
      <p>PDF to EPUB converts fixed-layout PDFs into reflowable e-books. This makes reading on small screens, such as phones and e-readers, much more comfortable as the text adjusts to fit the screen.</p>
      <p>The tool attempts to identify headings, chapters, and images to create a structured e-book. Perfect for converting PDF books and long documents for mobile reading.</p>
      <p>All processing happens locally in your browser, ensuring your books remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF book or click to select.' },
      { step: 2, title: 'Settings', description: 'Enter book metadata like Title and Author for the EPUB.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the EPUB file and download for your e-reader.' },
    ],
    useCases: [
      { title: 'Mobile Reading', description: 'Read PDF content comfortably on smartphones and tablets.', icon: 'smartphone' },
      { title: 'E-Reader Support', description: 'Convert PDFs for Kindle, Kobo, and other e-reading devices.', icon: 'book' },
      { title: 'Accessibility', description: 'Improve readability with adjustable fonts and text sizes in EPUB.', icon: 'user-check' },
    ],
    faq: [
      { question: 'Will formatting change?', answer: 'Yes, EPUB is reflowable, so fixed PDF layouts are converted to a flexible structure.' },
      { question: 'Does it support Kindle?', answer: 'Yes, most modern Kindles support EPUB directly, or you can use our MOBI converter.' },
      { question: 'Can it convert scanned PDFs?', answer: 'Scanned PDFs require OCR first to extract text for e-book conversion.' },
    ],
  },
  'pdf-to-mobi': {
    title: 'PDF to MOBI',
    metaDescription: 'Convert PDF to MOBI e-books. Optimized for Kindle devices with proper formatting.',
    keywords: ['pdf to mobi', 'convert pdf to kindle', 'mobi converter', 'pdf ebook'],
    description: `
      <p>PDF to MOBI converts your documents into the MOBI/AZW format used by Amazon Kindle devices. This provides a native reading experience on older and specialized Kindle models.</p>
      <p>The tool optimizes text flow and image placement for Kindle screens. Ideal for long-form documents, manuals, and books stored in PDF format.</p>
      <p>All processing happens locally in your browser, ensuring your documents remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Meta Info', description: 'Add book title, author, and optional cover image.' },
      { step: 3, title: 'Convert and Download', description: 'Create the MOBI file and download for your Kindle.' },
    ],
    useCases: [
      { title: 'Kindle Reading', description: 'Enjoy PDF books on Kindle with native feature support.', icon: 'book-open' },
      { title: 'Offline Reading', description: 'Convert documents for reading on dedicated e-ink devices.', icon: 'wifi-off' },
      { title: 'Legacy Support', description: 'Support for older e-readers that prefer MOBI over EPUB.', icon: 'history' },
    ],
    faq: [
      { question: 'What is MOBI?', answer: 'MOBI is an e-book format originally used by Mobipocket and adopted by Amazon for Kindle.' },
      { question: 'Difference from EPUB?', answer: 'MOBI is proprietary to Amazon/Kindle; EPUB is the open industry standard.' },
      { question: 'How to transfer to Kindle?', answer: 'Connect via USB or use Amazon\'s "Send to Kindle" service.' },
    ],
  },
  'pdf-to-djvu': {
    title: 'PDF to DJVU',
    metaDescription: 'Convert PDF to DJVU format. Specialized compression for high-resolution scanned documents.',
    keywords: ['pdf to djvu', 'convert pdf to scan', 'high compression docs', 'djvu converter'],
    description: `
      <p>PDF to DJVU converts your documents to the DjVu format, which is scientifically designed for scanned documents. DjVu offers extreme compression ratios for high-resolution color pages.</p>
      <p>Perfect for digital libraries and archives of scanned books where you need high quality but very small file sizes. Maintains document structure and text layers.</p>
      <p>All processing happens locally in your browser, ensuring your archives remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF (ideally scanned) or click to select.' },
      { step: 2, title: 'Select Quality', description: 'Choose compression level and resolution for DJVU output.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the DJVU file and download for archiving.' },
    ],
    useCases: [
      { title: 'Digital Libraries', description: 'Achieve significant space savings for large scanned collections.', icon: 'library' },
      { title: 'Historical Archives', description: 'Store high-resolution images of heritage documents efficiently.', icon: 'archive' },
      { title: 'Sharing Scans', description: 'Send high-quality scanned documents over limited bandwidth.', icon: 'share' },
    ],
    faq: [
      { question: 'What is DJVU?', answer: 'DjVu is a document format that uses advanced segmentation to compress scanned images extremely well.' },
      { question: 'Is it better than PDF?', answer: 'For scanned documents, DjVu often provides 5-10x better compression than standard PDF.' },
      { question: 'How to view DJVU?', answer: 'Use dedicated viewers like DjView or browser extensions.' },
    ],
  },
  'pdf-to-fb2': {
    title: 'PDF to FB2',
    metaDescription: 'Convert PDF to FictionBook (FB2). Semantic XML-based e-book format for structured reading.',
    keywords: ['pdf to fb2', 'fictionbook converter', 'pdf ebook xml', 'convert pdf to structured text'],
    description: `
      <p>PDF to FB2 converts documents into the FictionBook (XML) format. FB2 is a semantic format that describes the structure of a book rather than its appearance, making it highly versatile for reading apps.</p>
      <p>This tool extracts text, metadata, and images while maintaining logical structure. Widely used in various e-reading communities for its openness and semantic nature.</p>
      <p>All processing happens locally in your browser, ensuring your content remains private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Book Info', description: 'Verify metadata like genre, author, and book title.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the FB2 file and download for your favorite reader.' },
    ],
    useCases: [
      { title: 'Semantic Reading', description: 'Use readers that style books based on your personal preferences.', icon: 'settings' },
      { title: 'Open Formats', description: 'Keep your library in a fully open, XML-based semantic format.', icon: 'unlock' },
      { title: 'Cross-Device Sync', description: 'FB2 files are lightweight and easy to sync across multiple reading devices.', icon: 'refresh-ccw' },
    ],
    faq: [
      { question: 'What is FB2?', answer: 'FictionBook (FB2) is an XML-based e-book format that focuses on semantic markup.' },
      { question: 'Where is it popular?', answer: 'FB2 is very popular in Eastern Europe and among fans of open document standards.' },
      { question: 'Can I add a cover?', answer: 'Yes, you can specify or extract a cover image during conversion.' },
    ],
  },
  'pdf-to-email': {
    title: 'PDF to Email (EML)',
    metaDescription: 'Convert PDF to EML email files. Extract text and images into a draft email format.',
    keywords: ['pdf to email', 'pdf to eml', 'extract pdf to mail', 'pdf draft converter'],
    description: `
      <p>PDF to Email converts your PDF content into a draft email file (.eml). It extracts text as the body and attempts to place images as inline assets or attachments.</p>
      <p>Perfect for turning PDF newsletters, reports, or memos into email drafts that you can open in Outlook, Gmail, or Apple Mail. Saves time on copy-pasting and manual formatting.</p>
      <p>All processing happens locally in your browser, ensuring your emails remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF file or click to select.' },
      { step: 2, title: 'Draft Settings', description: 'Add default subject and sender info if desired.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the EML file and open it in your email client.' },
    ],
    useCases: [
      { title: 'Newsletter Migration', description: 'Turn PDF newsletters into email campaigns quickly.', icon: 'mail' },
      { title: 'Briefing Sharing', description: 'Share PDF briefings as the actual body of an email.', icon: 'send' },
      { title: 'Content Extraction', description: 'Convert PDF reports into editable email reports.', icon: 'file-text' },
    ],
    faq: [
      { question: 'What is an EML file?', answer: 'EML is a standard file format for email messages containing headers and body content.' },
      { question: 'Which email apps open it?', answer: 'Outlook, Apple Mail, Thunderbird, and nearly all desktop mail clients support EML.' },
      { question: 'How is formatting handled?', answer: 'The tool converts PDF blocks into HTML sections to maintain basic layout in the email body.' },
    ],
  },
  'pdf-to-cbz': {
    title: 'PDF to CBZ',
    metaDescription: 'Convert PDF to Comic Book Archive (CBZ). Package document pages as an image archive for comic readers.',
    keywords: ['pdf to cbz', 'document to comic', 'pdf image archive', 'comic creator'],
    description: `
      <p>PDF to CBZ converts your documents into a Comic Book Archive. Each PDF page is rendered as a high-quality image and packaged into a ZIP archive with a .cbz extension.</p>
      <p>Ideal for converting digital comics, art books, or manuals stored as PDF for use in specialized comic reading applications like Chunky or CDisplayEx.</p>
      <p>All processing happens locally in your browser, ensuring your archives remain private.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your PDF', description: 'Drag and drop your PDF or click to select.' },
      { step: 2, title: 'Quality Settings', description: 'Select image format (JPG/PNG) and resolution for the comic pages.' },
      { step: 3, title: 'Convert and Download', description: 'Generate the CBZ file and download for your comic reader.' },
    ],
    useCases: [
      { title: 'Comic Reading', description: 'View PDFs in apps optimized for high-performance image browsing.', icon: 'image' },
      { title: 'Art Portfolios', description: 'Convert art book PDFs into manageable image collections.', icon: 'palette' },
      { title: 'Asset Packaging', description: 'Extract all pages as organized images in a single archive.', icon: 'package' },
    ],
    faq: [
      { question: 'What is CBZ?', answer: 'A CBZ file is strictly a ZIP archive containing images, used primarily by comic book readers.' },
      { question: 'Which format is best?', answer: 'JPG for smaller file size, PNG for maximum quality and no compression artifacts.' },
      { question: 'Can I select pages?', answer: 'Yes, you can convert all pages or a specific range into the CBZ archive.' },
    ],
  },
};
