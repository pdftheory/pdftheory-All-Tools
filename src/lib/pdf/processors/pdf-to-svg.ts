...
export class PDFToSVGProcessor extends BasePDFProcessor {
    ...
    private async renderPageToSVG(
        ...
        // Use canvas-based rendering directly (reliable method)
        // Note: SVGGraphics is experimental in pdfjs-dist and often returns empty SVG
        // when PDF resources (fonts, images) aren't pre-loaded. The canvas-based
        // approach is the standard, reliable method.
