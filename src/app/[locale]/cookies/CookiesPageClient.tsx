                    ...
                    <article className="prose prose-gray prose-lg max-w-none">
                        ...
                        <section id="third-party" className="scroll-mt-8 pt-8 border-t border-gray-200 mt-12">
                            ...
                            <p className="text-gray-700 mb-4 leading-relaxed">
                                We use cookies from third-party services (Google Analytics, Google AdSense, etc.) to provide analytics and personalized ads. These third parties may collect information about your browsing activity across multiple websites.
                            </p>
                            ...
                            <ul className="list-disc pl-6 space-y-2 text-gray-700 mt-4">
                                ...
                                <li><a href="https://policies.google.com/technologies/ads" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Google AdSense Privacy & Terms</a></li>
                            </ul>
                        </section>
