...
export default function DashboardPage() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="mb-12">
                <h1 className="text-4xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">Developer Dashboard</h1>
                <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed max-w-3xl">
                    Manage your API keys and monitor your application usage.
                </p>
            </div>
                ...
                <div className="mb-8 p-6 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-xl">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            <h3 className="font-bold text-blue-900 dark:text-blue-100 mb-2">API Key Created Successfully</h3>
