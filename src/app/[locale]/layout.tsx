...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return generateHomeMetadata(validLocale, { title: t('home.title'), description: t('home.description') });
}
          ...
          <AuthProvider>
            <EzoicProvider>
              <div className="min-h-screen flex flex-col">
                ...
                <GlobalLayout locale={locale as any}>{children}</GlobalLayout>
              </div>
            </EzoicProvider>
          </AuthProvider>
          <Script src="//g.ezoic.net/ezoic/sa.min.js" strategy="afterInteractive" async />
